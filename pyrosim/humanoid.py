...
class ROBOT:
    ...
    def Send_Objects(self, sim, color):
        ...
        # legs
        sim.Send_Cylinder(objectID=self.num_objects, x=-.5*c.L, y=0, z=c.L+c.R, r1=0, r2=0, r3=1,
                          length=2*c.L, radius=c.R, r=color[0], g=color[1], b=color[2])
        self.num_objects += 1
        ...
        # arms
        sim.Send_Cylinder(objectID=self.num_objects , x=-.75*(c.L+c.R), y=0, z=3*c.L-c.R, r1=0, r2=0, r3=1,
                          length=2*c.L, radius=.5*c.R, r=color[0], g=color[1], b=color[2], mass=0.5)
        self.num_objects += 1
