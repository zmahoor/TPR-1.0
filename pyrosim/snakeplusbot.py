...
class ROBOT:
    ...
    def Get_Raw_Sensors(self, sim):
        ...
        self.raw_sensors['P2'] = copy.deepcopy(sim.Get_Sensor_Data(5, 0))
        self.raw_sensors['P3'] = copy.deepcopy(sim.Get_Sensor_Data(6, 0))

        self.raw_sensors['R0'] = copy.deepcopy(sim.Get_Sensor_Data(7, 0))
