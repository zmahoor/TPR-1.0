...
#sim.Send_Joint( jointID = 0 , firstObjectID = 0 , secondObjectID = 1, n1 = -1 , n2 = 0 , n3 = 0, x=0, y=0, z=1.1)
#sim.Send_Joint( jointID = 0 , firstObjectID = 0 , secondObjectID = 1, n1 = -1 , n2 = 0 , n3 = 0, x=0, y=0, z=1.1, lo=-3.14159/2 , hi=3.14159/2)

sim.Send_Cylinder( objectID=1, x=0.5 , y=0 , z=1.1 , r1=1 , r2=0, r3=0, length=1.0 , radius=0.1, r=1, g=0, b=0)
sim.Send_Joint( jointID = 0 , firstObjectID = 0 , secondObjectID = 1, n1 = -1 , n2 = 0 , n3 = 0, x=0, y=0, z=1.1)

# sim.Send_Joint( jointID = 0 , firstObjectID = 0 , secondObjectID = 1, n1 = 0 , n2 = -1 , n3 = 0, x=0, y=0, z=1.1)
