...
# ax.legend((point0[0], point1[0], point2[0]), ("Experiment", "Permuted Control", "Random Control"),
...
regular = pd.read_csv("critic_results_regular.csv", index_col=0).transpose()
permuted = pd.read_csv("critic_results_permuted.csv", index_col=0).transpose()
