...
class OBJECT: 
    ...
    def Get_Touch_Sensor_Value(self):
        if self.touchSensor:
            return self.touchSensor.Get_Mean_Value()
        else:
            return 0
    ...
    def Send_To_Simulator(self, simulator, color):
        if self.parent is None:
            ...
            simulator.Send_Cylinder(objectID=self.ID, x=x, y=y, z=z, r1=r1, r2=r2, r3=r3,
                                    length=length, radius=c.radius, r=color[0], g=color[1], b=color[2])
